...
public class StringUtils extends org.apache.commons.lang.StringUtils{
	...
	/**
	 * 删除目标字符串
	 * 删除参数1中的字符串，参数2和参数3是开始的节点和结束的节点  如果有多个匹配将会从该字符串中全部删除
	 * */
	public static String deleteTargetStr(String baseStr,String start,String end){
		while(true){
			if(baseStr.indexOf(start)!=-1 && baseStr.indexOf(end)!=-1 ){
				baseStr = baseStr.replace(baseStr.substring(baseStr.indexOf(start), baseStr.indexOf(end)+end.length()),"");
			}else{
				break;
			}
		}
